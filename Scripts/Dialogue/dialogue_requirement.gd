...
## The type of requirement that's needed
...
## The name of the requirement to be displayed alongside the dialogue choice
@export var dialogue_requirement_name: String